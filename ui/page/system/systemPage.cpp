...
REGISTER_PAGE(SystemPage, );

SystemPage::SystemPage(UiObject *parant) : UiObject() {
    mode = UNIQUE_MODE;
}
...
void lv_example_menu_5(lv_obj_t *parent)
{
...
static void back_event_handler(lv_event_t * e) {    // 返回
 ...
 * 
 */
void SystemPage::logicInit() { 

}

lv_obj_t *SystemPage::Init(lv_obj_t *parent) {
    _parent = parent;
    styleInit();
    uiInit();
    logicInit();
...
void SystemPage::Deinit(lv_obj_t *obj) {
